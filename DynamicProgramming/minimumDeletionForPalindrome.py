...
"""
def minimum_deletion_palindrome(str_):
...
def main():
  print(minimum_deletion_palindrome("abdbca"))
  print(minimum_deletion_palindrome("cddpd"))
  print(minimum_deletion_palindrome("pqr"))
